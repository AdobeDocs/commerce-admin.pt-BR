...
description: Defina as quantidades disponíveis e os limites por origem em uma página de produto para manter a precisão do estoque de venda [!DNL Inventory Management] .
