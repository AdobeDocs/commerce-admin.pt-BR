...
<table style="table-layout:auto;">
  ...
  <tbody>
    <tr>
      <td><p>Adição de instruções do Adobe Commerce as a Cloud Service para <a href="https://experienceleague.adobe.com/en/docs/commerce-admin/customers/customer-accounts/manage/login-as-customer">Fornecer assistência ao comprador</a>.</p>
</td>
      <td>
...
<table style="table-layout:auto;">
  ...
  <tbody>
    <tr>
      <td><p><a href="https://experienceleague.adobe.com/en/docs/commerce-admin/marketing/communications/email-reminders/email-reminder-rules">Lembretes de email</a> agora estão disponíveis no Adobe Commerce as a Cloud Service.</p>
</td>
      <td>
        Atualização importante
      </td>
...
<table style="table-layout:auto;">
  ...
  <tbody>
    <tr>
      <td><p>Atualização da medalha PaaS somente na página <a href="https://experienceleague.adobe.com/en/docs/commerce-admin/start/reporting/reports-menu">Menu de relatórios</a>.</p>
</td>
      <td>
        Feedback
      </td>
