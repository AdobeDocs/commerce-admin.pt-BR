...
description: Expanda do inventário de uma única origem para o de várias origens ou reestruture de volta para uma única origem à medida que seus negócios mudam.
