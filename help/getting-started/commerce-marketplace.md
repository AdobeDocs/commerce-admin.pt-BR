...
- [Configuração da malha de API para o Adobe Developer App Builder](https://developer.adobe.com/graphql-mesh-gateway/mesh/basic/)
- [Implantação de aplicativos do App Builder](https://developer.adobe.com/app-builder/docs/guides/app_builder_guides/deployment/deployment)
- [CI/CD para aplicativos App Builder](https://developer.adobe.com/app-builder/docs/guides/app_builder_guides/deployment/cicd-for-app-builder-apps)
...
>[!IMPORTANT]
>
>A partir do Adobe Commerce e do Magento Open Source 2.4.0, o Assistente de Instalação da Web é removido e você deve usar a linha de comando para [instalar](https://experienceleague.adobe.com/en/docs/commerce-operations/installation-guide/advanced) ou [atualizar](https://experienceleague.adobe.com/en/docs/commerce-operations/upgrade-guide/implementation/perform-upgrade) sua instância. Este requisito também inclui [módulos](https://experienceleague.adobe.com/en/docs/commerce-operations/upgrade-guide/modules/upgrade) e [extensões](https://experienceleague.adobe.com/en/docs/commerce-operations/installation-guide/tutorials/extensions).
...
Método 1: envie uma solicitação de suporte do formulário [Adobe Commerce Marketplace - Fale Conosco](https://commercemarketplace.adobe.com/contact-us/).
