...
Se precisar [enviar seu primeiro tíquete](https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide#support-case) ou gerenciar sua relação com o Adobe Commerce, em vez de trabalhar em uma vitrine específica, comece criando ou acessando sua conta do [!DNL Commerce].
