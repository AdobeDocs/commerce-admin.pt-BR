...
description: Visão geral da configuração de  [!DNL Inventory Management]  no nível do catálogo e do produto para exibição de vitrine, estoque e comportamento de remessa.
