...
![Configurações básicas de check-out no PayPal Express](./assets/payment-methods-paypal-advanced-express-checkout-basic-settings.png)<!-- zoom -->
...
![Configurações avançadas de finalização de compra do PayPal Express](./assets/payment-methods-paypal-payments-advanced-express-checkout-advanced.png)<!-- zoom -->
