...
![Magento Open Source](../assets/open-source.svg) A base de código Magento Open Source oferece suporte ao uso de uma única lista de desejos por conta de cliente.
