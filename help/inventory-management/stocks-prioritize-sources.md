...
description: Defina a ordem de prioridade de origem em um estoque no Administrador para controlar as recomendações do Source Selection Algorithm durante a entrega.
