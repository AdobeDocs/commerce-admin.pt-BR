...
>[!NOTE]
>
>A FedEx pode usar [peso dimensional](carriers.md#dimensional-weight) para determinar algumas taxas de envio. No entanto, a Adobe Commerce e a Magento Open Source oferecem suporte apenas ao cálculo de custos de envio com base em peso.
...
1. Se você tiver credenciais separadas da API de rastreamento, habilite a seguinte configuração:
