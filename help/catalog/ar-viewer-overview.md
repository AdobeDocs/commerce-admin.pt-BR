...
O [!DNL AR Viewer] é compatível com o [!DNL Magento Open Source] e o Adobe Commerce. Consulte a [Política de Ciclo de Vida](https://experienceleague.adobe.com/en/docs/commerce-operations/release/planning/lifecycle-policy){target=_blank} para obter mais informações sobre as versões com suporte.
