---
title: Introdução ao [!DNL B2B for Adobe Commerce]
description: Saiba como usar recursos B2B integrados para atender às suas necessidades para clientes que são empresas.
