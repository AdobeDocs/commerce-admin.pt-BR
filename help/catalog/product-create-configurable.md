...
**Recomendado para:** produtos com várias opções (cor, tamanho, material, etc.) onde é necessário rastrear o inventário para cada variação. A configuração inicial leva mais tempo, mas fornece melhor escalabilidade.
