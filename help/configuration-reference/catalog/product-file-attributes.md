...
description: Revise as configurações na página [!UICONTROL Catalog] > [!UICONTROL Product File Attributes] do Administrador do Commerce.
...
![Atributos do arquivo do produto](./assets/file-validation.png)
