...
![Configurações Básicas de Check-out do PayPal Express](./assets/payment-methods-paypal-payflow-link-express-checkout-basic-settings.png)<!-- zoom -->
