...
|----------------|-----------|-------|
| 2.4.7-p4 e versões posteriores -p | 1.2.0 | O suporte para 2.4.7-p4 requer um [hotfix](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27147) |
