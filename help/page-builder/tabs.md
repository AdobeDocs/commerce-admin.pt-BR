---
title: Layout - Guias
description: Saiba mais sobre o tipo de conteúdo de Guias, usado para adicionar um conjunto de guias na [!DNL Page Builder] estágio.
...
Use o _Guias_ tipo de conteúdo ao qual será adicionado um conjunto de guias na [[!DNL Page Builder] estágio](workspace.md#stage). Ao arrastar o espaço reservado Tabulações do painel para o estágio, uma única guia padrão é exibida inicialmente. É possível adicionar mais guias para criar um conjunto completo. A largura do conjunto de guias é determinada pela largura de seu container principal e pelas configurações de preenchimento.
...
Ao trabalhar com a variável _Guias_ tipo de conteúdo, você adiciona e edita guias individuais e o contêiner de guias que contém uma ou mais guias. Cada guia tem sua própria caixa de ferramentas usada para criar guias na [!DNL Page Builder] estágio.

### Caixa de ferramentas de guia Individual

![Caixa de ferramentas Guia](./assets/pb-layout-tab1-toolbox.png){width="500" zoomable="yes"}
...
| Configurações | ![Ícone Configurações](./assets/pb-icon-settings.png){width="25"} | Abre a página Editar guias, onde é possível alterar as propriedades da guia individual. |
| Duplicar | ![Ícone Duplicar](./assets/pb-icon-duplicate.png){width="25"} | Faz uma cópia da guia. |
...
| Configurações | ![Ícone Configurações](./assets/pb-icon-settings.png){width="25"} | Abre a página de guia Editar, onde é possível alterar as propriedades do container. |
...
| Duplicar | ![Ícone Duplicar](./assets/pb-icon-duplicate.png){width="25"} | Faz uma cópia da guia atual. |
...
1. No [!DNL Page Builder] painel em _[!UICONTROL Layout]_, arraste o **[!UICONTROL Tabs]**o espaço reservado diretamente para o estágio ou para uma linha ou coluna no estágio.

   ![Arrastar guias para uma linha](./assets/pb-layout-tabs-drag-row.png){width="600" zoomable="yes"}

1. Clique em **[!UICONTROL Tab 1]** rótulo para exibir a caixa de ferramentas de guia individual e escolher o _Configurações_ ( ![Ícone Configurações](./assets/pb-icon-settings.png){width="20"} ) ícone.

1. Insira o **[!UICONTROL Tab Name]** que você deseja usar como rótulo.

   ![Inserção do nome da guia](./assets/pb-layout-tab1-toolbox-settings-general-tab-name.png){width="600" zoomable="yes"}

1. Se necessário, insira o **[!UICONTROL Minimum Height]** para a guia.

   Esse valor pode ser um número com qualquer unidade CSS válida (como `100px`, `50%`, `50em`, `100vh`) ou um cálculo (como `100vh - 237px`).

1. Escolha um **[!UICONTROL Vertical Alignment]** configuração para alinhar qualquer contêiner de conteúdo adicionado à guia (Superior, Centro ou Inferior).
...
1. Passe o mouse sobre o contêiner de guias para exibir a caixa de ferramentas e escolher o _Adicionar_ ( ![Ícone Adicionar](./assets/pb-icon-add.png){width="20"} ) ícone.

1. Clique em **[!UICONTROL Tab 2]** rótulo para exibir o cursor e insira seu próprio rótulo para a guia.

1. Clique na segunda guia novamente no palco e escolha a guia _Duplicar_ ( ![Ícone Duplicar](./assets/pb-icon-duplicate.png){width="20"} ) ícone.

1. Clique em seu nome **[!UICONTROL Copy]** rótulo para exibir o cursor e insira seu próprio rótulo para a terceira guia.

![Combinação de conjuntos de guias com a caixa de ferramentas](./assets/pb-layout-tabs3-toolbox-main.png){width="600" zoomable="yes"}

## Mover uma guia dentro do conjunto

1. Clique na guia que deseja mover.

1. Selecione e arraste o _Mover_ ( ![Ícone Mover](./assets/pb-icon-move.png){width="20"} ), que aparece antes do texto do rótulo da guia, para uma nova posição dentro do conjunto de guias.
...
1. No [!DNL Page Builder] painel, expandir **[!UICONTROL Elements]** e arraste uma **Texto** espaço reservado para a guia.

1. Insira ou cole algum texto no editor e use a barra de ferramentas do editor para formatá-lo conforme necessário.

   Consulte [Elementos - Texto](text.md) para obter mais informações sobre como trabalhar com o tipo de conteúdo text.

   ![Edição de conteúdo de texto adicionado à guia](./assets/pb-layout-tab-text.png){width="500" zoomable="yes"}

1. No canto superior direito, clique em **[!UICONTROL Save]**.

## Alterar configurações de guia individuais

1. Passe o mouse sobre uma guia individual para exibir a caixa de ferramentas e escolher a _Configurações_ ( ![Ícone Configurações](./assets/pb-icon-settings.png){width="20"} ) ícone.

1. Se necessário, altere qualquer uma das configurações básicas da guia:

   - **[!UICONTROL Tab Name]** - Digite o texto revisado para o rótulo da guia. Também é possível modificar o rótulo diretamente no palco.
...
- **[!UICONTROL Background Image]** - Se necessário, use as ferramentas fornecidas para escolher uma imagem de fundo para aplicar à guia:
...
- **[!UICONTROL Background Position]** - Escolha como a imagem de fundo é ancorada em relação à guia: `Top Left` / `Top Center` / `Top Right` / `Center Left` / `Center` / `Center Right` / `Bottom Left` / `Bottom Center` / `Bottom Right`

- **[!UICONTROL Background Attachment]** - Escolha o tipo de anexo para determinar como a imagem do plano de fundo se move em relação à página de rolagem:
...
- **[!UICONTROL Background Repeat]** - Defina como `Yes` para repetir a imagem de fundo para preencher o espaço disponível na guia.

### Avançado

- Para controlar o alinhamento horizontal dos contêineres de conteúdo adicionados à guia, escolha uma **[!UICONTROL Alignment]** .
...
- Defina o **[!UICONTROL Border]** estilo aplicado aos quatro lados do contêiner de tabulação:
...
1. Passe o mouse sobre a borda superior do contêiner do conjunto de guias para exibir a caixa de ferramentas e escolher o _Configurações_ ( ![Ícone Configurações](./assets/pb-icon-settings.png){width="20"} ) ícone.
...
1. Para posicionar as guias de navegação na parte superior do conjunto de guias, escolha a guia **[!UICONTROL Tab Navigation Alignment]** (`Left`, `Center`ou `Right`).
...
1. Defina as opções Avançadas para o conjunto de guias:
   ...
   - Para controlar o posicionamento do conjunto de guias no container-pai, escolha uma **[!UICONTROL Alignment]**:
   ...
   - Defina o **[!UICONTROL Border]** estilo aplicado aos quatro lados do contêiner de guias:
   ...
   - (Opcional) Especifique os nomes dos **[!UICONTROL CSS classes]** na folha de estilos atual para aplicar ao contêiner de guias.

     Separe vários nomes de classe com um espaço.

   - Insira valores, em pixels, para o **[!UICONTROL Margins and Padding]** para determinar as margens externas e o preenchimento interno do contêiner de guias.
