...
>[!VIDEO](https://video.tv.adobe.com/v/3443512?captions=por_br&quality=12&learn=on)
...
|  | `Sales Channel` | [`Amazon Sales Channel`](https://experienceleague.adobe.com/pt-br/docs/discontinued/using/commerce-channels) |
...
|  | `System Insights` ![Adobe Commerce](../assets/adobe-logo.svg) | [`Site-Wide Analysis Tool`](https://experienceleague.adobe.com/pt-br/docs/commerce-operations/tools/site-wide-analysis-tool/access) |
