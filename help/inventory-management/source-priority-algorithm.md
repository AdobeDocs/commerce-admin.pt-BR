...
description: Configure a ordem de prioridade de origem em um estoque para que o algoritmo Prioridade do Source recomende origens para remessas e deduções.
