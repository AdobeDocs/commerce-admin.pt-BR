...
description: Importar e exportar  [!DNL Inventory Management] atribuições de origem e quantidades por origem por SKU usando ferramentas de transferência de dados de catálogo nativo.
