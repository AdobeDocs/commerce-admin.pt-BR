...
Se você precisar [enviar seu primeiro tíquete de Suporte](https://experienceleague.adobe.com/pt-br/docs/commerce-knowledge-base/kb/help-center-guide/magento-help-center-user-guide#support-case) ou gerenciar o relacionamento com a Adobe Commerce fora de uma vitrine específica, comece criando ou acessando sua conta do [!DNL Commerce].
