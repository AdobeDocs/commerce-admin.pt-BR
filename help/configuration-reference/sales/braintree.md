...
| [!UICONTROL Enable Vault CVV Reverification] | Site | Quando ativada, a validação é feita para a configuração de regras CVV na sua conta do Braintree. Opções: `Yes` / `No` |
