...
1. Defina **[!UICONTROL Payment Action]** como um dos seguintes:
   ...
   - `Intent Sale` - O valor da compra é autorizado e imediatamente retirado da conta do cliente. **_Note:_**Este valor era_ Autorizar e Capturar_ na versão 2.3.x e em versões anteriores.|
