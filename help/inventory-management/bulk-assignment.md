...
description: Use a ação de atribuição de fontes em massa no Administrador para atribuir ou cancelar a atribuição de  [!DNL Inventory Management]  fontes para muitos produtos de uma só vez.
