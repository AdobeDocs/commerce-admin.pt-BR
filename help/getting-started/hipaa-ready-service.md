...
- **[Serviço SendGrid](https://experienceleague.adobe.com/docs/commerce-cloud-service/user-guide/project/sendgrid.html)** — Este serviço está desabilitado por padrão porque o aplicativo não é compatível com HIPAA.
